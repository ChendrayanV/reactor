...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Get2 = 'Microsoft.Graph.DirectoryObjects.private\Get-MgDirectoryObject_Get2';
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Restore1 = 'Microsoft.Graph.DirectoryObjects.private\Restore-MgDirectoryObject_Restore1';
            RestoreViaIdentity1 = 'Microsoft.Graph.DirectoryObjects.private\Restore-MgDirectoryObject_RestoreViaIdentity1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB+qexzNtqzizkp
# IgaGBLlSyPaRjDoQUh7rvJkElN6fl6CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgzu8nK/Qu
# KXx8aPzRfAT+NWBZkJp7npoBEGpT9doFjMcwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQCZ8wa9ZzFVk5icJFv2zaeo3dQ/2mmiqFSCm0+cttn6
# ydBgaTI8UtvNT6lscWAm4hheMH1tigaEi5tGSsLcGQLgX0R5lPVabqKeD+yAvFZn
# 3GkIqn0jMzpY4JvMQuVCMZWdat9/VVTpJk1L+SMoJ6u5U1nDcPBdD3a0ZYXGGem6
# ktDXRSpRMzaEdRIqdEGEB70g0LcpfD40GBmpYkmntvcoLwzOB6mle1hFPGAv0PQw
# hndrv0CGGNFYYMBX1AHgHcKfTgt+aaj9MG8V77s8pB15TXEdBON/imixB1aj7LLg
# yfgp+/r6TlkUSZqS2MWMw7XnjfYy6IYBhYWD8jcp1VXboYIS/jCCEvoGCisGAQQB
# gjcDAwExghLqMIIS5gYJKoZIhvcNAQcCoIIS1zCCEtMCAQMxDzANBglghkgBZQME
# AgEFADCCAVkGCyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIMZHV8FtJCEewoi8ew9II1p7M7mRMK0O2z+vTuvZ
# odERAgZhcHkHNpAYEzIwMjExMDI3MDcxMTI0LjI4N1owBIACAfSggdikgdUwgdIx
...
# AQQwLwYJKoZIhvcNAQkEMSIEIN+s24mrjsA9rgorKKiHArZcoolYn9fPcquqdyl5
# bIokMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgUT8BPIzqc3SecHRPLKBt
...
# 9O/Sci8O3hwdWmbouUNrPjANBgkqhkiG9w0BAQsFAASCAQBQm8NfkU37DA5YZiK7
# qG4vdhCQFj8idXpc95wCQ2JThxbkRjq5G+YvkcDnB/M2jzigOjzIRBW0KCVN2Kg0
# mqU3g9J9cFTCGDLlCnLhXdP06ZqcU/2AIbwplQTZcS4jL2Yr0trDue7ae6vcnye6
# pieM3FUz8cOnoPrlx1d4Fw5oHbPM4HV003jlJzLgya0L+N01BbjEGNLl9Ww69yG4
# veJOA8BJ1Fz4BvimYy7vY3QoYXTfqa4hlc7jLtL+QT1ei7Vi3HlqSyDB3h9b6TbB
# 9Dujc09G0yUtLGEvf3gd/5Ztk9jUIjZLujcsgVP0x6RR3RLOvvE6aMwL+XWSCOYM
# SW0b
