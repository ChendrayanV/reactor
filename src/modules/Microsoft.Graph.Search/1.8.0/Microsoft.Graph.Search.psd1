...
GUID = 'd9ca52cd-547f-4be0-9a05-32862039f6a3'
...
FunctionsToExport = 'Get-MgExternal', 'Get-MgExternalConnection', 'Get-MgSearchAcronym', 
               'Get-MgSearchBookmark', 'Get-MgSearchEntity', 'Get-MgSearchQna', 
               'Invoke-MgQuerySearch', 'New-MgExternalConnection', 
               'New-MgSearchAcronym', 'New-MgSearchBookmark', 'New-MgSearchQna', 
               'Remove-MgExternalConnection', 'Remove-MgSearchAcronym', 
               'Remove-MgSearchBookmark', 'Remove-MgSearchQna', 'Update-MgExternal', 
               'Update-MgExternalConnection', 'Update-MgSearchAcronym', 
